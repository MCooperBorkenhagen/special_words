...
coverage %>% 
  ...
  rename(Resource = source, `WCBC (100-500-1000)` = wcbc, `TASA (100-500-1000)` = tasa, `CHILDES (100-500-1000)` = childes) %>% 
  apa_table(caption = "Proportion coverage of top 100, 500, and 1000 words from WCBC, TASA, and CHILDES for the five resources.",
