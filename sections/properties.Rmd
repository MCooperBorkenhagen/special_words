...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap='The raw distribution of words across sources and rank frequency (standardized) from the TASA corpus are shown as points (in grey) with point estimates from the statistical model shown as colored points within each distribution. Because standard errors are imperceptibly small, standard deviations for the standardized rank frequency values within each distribution are shown. All distributions are significantly different than the corpus mean (0).', fig.width=7}
