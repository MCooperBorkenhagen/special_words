...
## Discussion
Words are known to vary in terms of a number of properties that contribute to learning to read [@Zevin2002; @Zevin2004; @Hsaio2018; @Steacy2019; @Weekes2006]. Given that the instructional resources being studied here vary in terms of the words they contain, it could be that they nonetheless share a range of underlying properties, thus leaving these differences less meaningful. This turns out not to be the case, however. Noteworthy variability exists across the instructional wordlists along a range of variables, including frequency, consistency, imageability, age-of-acquisition, number of letters, and number of syllables. This is true also for several different frequency norms: those derived from spoken language to young children, recreational texts for young readers, and texts for adult readers.

Analyses of word frequency reveal a further observation: 
