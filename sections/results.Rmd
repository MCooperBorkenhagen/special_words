...
rank_inconsistency_rank_frequency %>% 
  ...
  rename(Rank = rank, Word = word, `Dist. (Euclidean)` = distance,
         `Constncy. (high-low)` = consistency_rank, `Freq. (low-high)` = tasa_rank) %>% 
