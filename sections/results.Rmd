...
table_desc %>% 
  ...
  apa_table(caption = "Descriptive Data for Frequency for Instructional Sources",
            note = "N indicates the number of unique words in each wordlist. Frequencies taken from TASA (Zeno et al., 1995). Raw = raw frequencies. Rank = rank frequencies. Values in parentheses are standard deviations.")
