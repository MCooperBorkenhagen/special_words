...
Table XX shows the number of words per program (broken out by grade where relevant), and Table XX displays the terms used by each program or author when referring to their special words.
